...
**Buildout** is a tool to manage a software build. It uses configurations so you can always reproduce the same environment. We use it to manage both our Python and Plone builds. 
